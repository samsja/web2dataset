...
__all__ = ['Downloader', 'BasicSearcher', 'DownloaderError', 'GoogleImageDownloaderError', 'GoogleImageDownloader']
...
class Downloader(ABC):
    ...
    Example:
    ```python
    >>> from web2dataset import Searcher
    >>> downloader = BasicSearcher()
