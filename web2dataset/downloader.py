...
__all__ = ['Downloader', 'DownloaderError', 'GoogleImageDownloaderError', 'GoogleImageDownloader']
...
class GoogleImageDownloader(Downloader):
    ...
    def _element_to_document(self, element, query: str):
        ...
        doc = Document(origin=query, uri=f"{self.path_image}/{id_}.jpg", tag={"uuid": id_}) # TODO use relative path
